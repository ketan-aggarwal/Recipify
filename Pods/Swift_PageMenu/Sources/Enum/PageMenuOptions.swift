...
//    }
    ...
    public var menuItemSize: PageMenuItemSize {
          let numberOfItems: CGFloat = 3 // You can change this according to your requirement
          let screenWidth = UIScreen.main.bounds.width - 40
          let itemWidth = screenWidth / numberOfItems
          return .fixed(width: itemWidth, height: 30)
      }
...
//        return UIColor(red: 3/255, green: 125/255, blue: 233/255, alpha: 1)
        return UIColor(red: 155/255, green: 203/255, blue: 65/255, alpha: 1)
    }
...
//        return .roundRect(rectColor: UIColor(red: 3/255, green: 125/255, blue: 233/255, alpha: 1), cornerRadius: 10, height: 22, borderWidth: nil, borderColor: nil)
        return .underline(barColor: UIColor(red: 155/255, green: 203/255, blue: 65/255, alpha: 1) , height: 2)
    }
    ...
    public var tabMenuBackgroundColor: UIColor {
        return UIColor(red: 31/255, green: 33/255, blue: 36/255, alpha: 1)
    }
